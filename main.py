...
parser = argparse.ArgumentParser(description="FTUNET3D segmentation pipeline")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="test", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./pretrained_models/", type=str, help="pretrained checkpoint directory"
)
parser.add_argument("--data_dir", default="./dataset/LITS17/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="dataset_1.json", type=str, help="dataset json file")
parser.add_argument(
    "--pretrained_model_name", default=None, type=str, help="pretrained model name"
)
...
parser.add_argument("--model_name", default="FTUNET3D", type=str, help="model name")
...
def main_worker(gpu, args):
    ...
    dice_loss = DiceCELoss(
        ...
        smooth_nr=args.smooth_nr, smooth_dr=args.smooth_dr, ce_weight=weights
    )
    ...
    elif args.optim_name == "AdaSwitch":
        optimizer = AdaSwitch(model.parameters(), lr=args.optim_lr, weight_decay=args.reg_weight)
    else:
